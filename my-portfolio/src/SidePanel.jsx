...
function SidePanel(){
  ...
  return(
    ...
    <nav>
      ...
      <div>
      <h3 className="opacity-75 @[200px]:text-[18px] @[240px]:text-[20px] @[277px]:text-1xl @[330px]:text-2xl tracking-widest font-normal mb-2 pt-6 pl-6">CONTACT</h3>
        <ul>
        <li>
          <Link to="#" onClick={handleMailClick} className="mt-1 font-normal pt-2 pl-6 @[200px]:text-[18px] @[240px]:text-[20px] @[277px]:text-1xl @[330px]:text-2xl inline-block p-2 rounded  hover:text-[#B6B6B4] hover:underline transition duration-200 ease-in-out">
            Mail
          </Link>
        </li>
        <li>
